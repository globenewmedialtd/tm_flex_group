...
namespace Drupal\tm_flex_group_community\Access;
 ...
 */
class TmCommunityJoinPermissionAccessCheck implements AccessInterface {
  ...
  public function access(Route $route, RouteMatchInterface $route_match, AccountInterface $account) {
    $permission = $route->getRequirement('_tm_community_join_permission');
    ...
    if ($type instanceof GroupTypeInterface && $type->id() !== 'tm_community') {
