...
namespace Drupal\tm_flex_group_training\Access;
 ...
 */
class TmTrainingJoinPermissionAccessCheck implements AccessInterface {
  ...
  public function access(Route $route, RouteMatchInterface $route_match, AccountInterface $account) {
    $permission = $route->getRequirement('_tm_training_join_permission');
    ...
    if ($type instanceof GroupTypeInterface && $type->id() !== 'tm_training') {
