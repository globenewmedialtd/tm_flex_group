...
class TmTrainingContentVisibilityUpdate {
  ...
  public static function batchUpdateGroupContentVisibility(Group $group, array $changed_visibility, array $new_options) {
    ...
    for ($i = 0; $i < $num_operations; $i++) {
      $operations[] = [
        '\Drupal\tm_flex_group_training\TmTrainingContentVisibilityUpdate::updateVisibility',
        [
          $entities[$i],
          $new_options,
        ],
    ...
    $batch = [
      ...
      'finished' => '\Drupal\tm_flex_group_training\TmTrainingContentVisibilityUpdate::updateVisibilityFinishedCallback',
    ];
