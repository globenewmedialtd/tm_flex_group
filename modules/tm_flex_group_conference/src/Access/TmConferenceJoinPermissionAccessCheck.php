...
namespace Drupal\tm_flex_group_conference\Access;
 ...
 */
class TmConferenceJoinPermissionAccessCheck implements AccessInterface {
  ...
  public function access(Route $route, RouteMatchInterface $route_match, AccountInterface $account) {
    $permission = $route->getRequirement('_tm_conference_join_permission');
    ...
    if ($type instanceof GroupTypeInterface && $type->id() !== 'tm_conference') {
